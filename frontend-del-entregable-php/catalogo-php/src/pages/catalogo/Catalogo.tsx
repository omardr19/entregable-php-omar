    ...
    useEffect(() => {
            const fetchData = async () => {
                try {
                    ...
                    const resProd = await axios.get("https://backend-omar-php.onrender.com/productos.php");
                    setProductos(resProd.data);
                    console.log("Productos cargados:", resProd.data);

                    console.log("Intentando cargar categorías...");
                    const resCat = await axios.get("https://backend-omar-php.onrender.com/categoria.php");
            ...
            <section className="catalogo-wrapper">
                ...
                {productosFiltrados.length > 0 ? (
                    ...
                    <div className="product-card" key={prod.id}>
                        ...
                        <img src={`https://backend-omar-php.onrender.com/IMG/productos/${prod.imagen}`} alt={prod.nombre} />
                        </div>
